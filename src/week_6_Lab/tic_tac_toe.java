...
public class tic_tac_toe {
	...
	public static void main(String[] args) {
		...
		String[] win1 = {gameBoard[0], gameBoard[1], gameBoard[2]};
		String[] win2 = {gameBoard[3], gameBoard[4], gameBoard[5]};
		String[] win3 = {gameBoard[6], gameBoard[7], gameBoard[8]};
		String[] win4 = {gameBoard[0], gameBoard[3], gameBoard[6]};
		String[] win5 = {gameBoard[1], gameBoard[4], gameBoard[7]};
		String[] win6 = {gameBoard[2], gameBoard[5], gameBoard[8]};
		String[] win7 = {gameBoard[0], gameBoard[4], gameBoard[8]};
		String[] win8 = {gameBoard[6], gameBoard[4], gameBoard[2]};
